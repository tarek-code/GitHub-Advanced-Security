...
هذا الملف يحتوي على **٧٥ سؤال اختياري (MCQ)** وإجاباتهم الخاصة بميزات الأمان في GitHub مثل:
- Code Scanning
- Dependabot
- Secret Scanning
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `creating a pull request to resolve the vulnerability that will be approved and merged`
...
- ✅ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `Common Weakness Enumeration (CWE)`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `a feature that analyzes the code in a GitHub repository to find security vulnerabilities and coding errors`
...
- ✅ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `install the CLI, analyze code, upload scan results`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `repository rulesets`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `GitHub personal access token`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `Enable push protection.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `creates a pull request to upgrade the vulnerable dependency to the minimum possible secure version`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `after you fix the code by committing within the pull request`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `a file in a GitHub repository that provides instructions to users about how to report a security vulnerability`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `dependency review`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `Add a repository ruleset, Establish the protection rules in the code security settings`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `It notifies the service provider who issued the secret.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `when you merge a pull request that contains a security update`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `The workflow file must exist in that branch.`
...
- ✅ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `Configure code scanning.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `a user who has write access to the repository`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `in the code security settings`
...
- ◻️ **C**
- ✅ **D**
**🟩 الإجابة الصحيحة:** `in Dependabot alerts`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `Remove the autobuild step from your code scanning workflow and add specific build steps.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `package-ecosystem`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `in manifest and lock files, in security advisories reported on GitHub`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `to scan and block the code that contains secrets before it reaches the repository`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `the secret format, the name of the pattern`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `a contributor adds the vulnerable dependency to a manifest in the repository.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `users with the Admin repository role, user who committed the secret`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `on: pull_request`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `all files in the repository, full commit history, all branches`
...
- ◻️ **C**
- ✅ **D**
**🟩 الإجابة الصحيحة:** `Sensitive information could be leaked, A dangerous argument could be passed to functions, Data could be used insecurely.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `GitHub performs a read-only analysis on the repository.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `how to report a vulnerability`
...
- ◻️ **C**
- ✅ **D**
**🟩 الإجابة الصحيحة:** `Dismiss the alert with the reason "false positive."`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `You can use the languages parameter under the init action.`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `Static Analysis Results Interchange Format (SARIF)`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `repository administrators`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `security_events`
...
- ◻️ **C**
- ◻️ **D**
**🟩 الإجابة الصحيحة:** `A pull request is opened that fixes a vulnerable dependency.`
